...
indir= '/network/group/aopp/planetary/PLR005_TABATABAVAKILI_PUMAGT'+'/for_peter/'
...
if len(sys.argv) == 1:
  ...
  ncfile = '/network/group/aopp/planetary/PLR005_TABATABAVAKILI_PUMAGT'+'/for_peter/rot0.5_a2.00.year10.nc'
  afac=1
  pfac=1
  outname='rot0.5_a2.00.year10'
  outdir='for_peter/'
  print ncfile
#elif len(sys.argv) == 3: 
#  ncfile = sys.argv[1]
...
DeltaTh=np.mean((t[:,0,:,:]-t[:,9,:,:]))

#print 'XXX',rotfac,DeltaTh
