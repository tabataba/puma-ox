...
YEAR='010'
indir= '/network/group/aopp/planetary/PLR005_TABATABAVAKILI_PUMAGT/'+'/noseasons_pumagt_arcb/'##'/noseasons_pumagt_arcb/'
outdir='plots/'
outdirpng='pics/'
...
if len(sys.argv) == 1:
  ...
  ncfile = '/network/group/aopp/planetary/PLR005_TABATABAVAKILI_PUMAGT'+'/noseasons_pumagt_arcb/rev53_r0.5_res64_radius1.00_taufr10.0_psurf1.0_pref1.0_taus10.00_tausurf36_nmu1/PUMAG.010.nc'
  afac=1
  pfac=1
  outname='test'
  rotfac=0.5
