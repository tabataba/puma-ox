...
cd pumagt_arcb_parameters #noseasons_pumagt_arcb #pumagt_arcb_parameters
#cd /media/Seagate5TB/puma/pumagt_arcb_parameters
PUMA=$PWD
#DATA="data/lorenz_en"

#dir=($(ls -d *))
dir=($(ls -d rev53_r0.0625_res64_radius1.00_taufr1.0_psurf0.04_pref0.04_taus0.20_tausurf*_nmu*))
dir=($(ls -d rev53_r*_res64_radius1.00_taufr1.0_psurf1.0_pref1.0_taus0.00_tausurf360_nmu1))
#dir=($(ls -d rev53_r_res64_radius1.00_taufr1.0_psurf1.0_pref1.0_taus10.00_tausurf360_nmu*))
