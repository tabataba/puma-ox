...
indir= '/network/group/aopp/planetary/PLR005_TABATABAVAKILI_PUMAGT'+'/sol_pumagt_arcb/'
outdir='data/stats_sol_ex1/'
...
#  ncfile = sys.argv[1]
  ...
  nmufac=string[nmupos+len(str9):solpos]#8
  solfac=string[solpos+len(str10):len(string)]#9
...
uoutname=outdir+'ustats_ex1'+'_nmu'+str(nmufac)+'_sol'+str(solfac)+'_dt'+str(days)+'.txt'
try:
