...
DIRNAME="pumagt_arcb_rot_tausurf_radtest7_UradilxALBEDO_newsurf_convdelay/"
...
for i in 1.0 #0.03125  0.0455  #0.0625 #2.0 4.0 8.0 0.125 0.25 0.5 1.0 #2.0 4.0 8.0 #2.0 4.0 8.0 #0.125 0.25 0.5 1.0 #2.0 4.0 8.0   ###1.0 0.44 0.14 0.044 2.0 #0.44 1.0
do
for k in 7 #0.5 7 30 90 360 
do
for iii in 1 0
do
...
#do
  ...
  cp -rf $HOM/puma/trunk/pumagt_radtest $LOCATION/$BASENAME$i$NAME2$j$NAME3$k$NAME4$iii
