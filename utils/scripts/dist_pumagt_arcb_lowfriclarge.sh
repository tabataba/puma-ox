...
a="$(round 1.0 2)"
fricfac="$(round 0.1 1)"
psurffac="$(round 1.0 1)"
preffac="$(round 1.0 1)"
taus="$(round 0.0 2)"
for i in 1.0 #2.0 0.0625 0.125 0.25 0.5 1.0 #2.0 4.0 8.0   ###1.0 0.44 0.14 0.044 2.0 #0.44 1.0
do
for k in 3.6 #3.6 36 360 #0.5 7 30 90 360 
do
for iii in 1 #0 #1
do
for taus in 10.00 #0.00 2.00 10.00
do
