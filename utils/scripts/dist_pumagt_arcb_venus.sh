...
DIRNAME="pumagt_arcb_venus_param/"
...
a="$(round 1.0 2)"
fricfac="$(round 1 1)"
psurffac="$(round 90.0 1)"
preffac="$(round 90.0 1)"
taus="$(round 0.0 2)"
taul="$(round 473.56 2)"
for i in  0.0078125 #2.0 0.0625 0.125 0.25 0.5 1.0 #2.0 4.0 8.0   ###1.0 0.44 0.14 0.044 2.0 #0.44 1.0
do
for k in 360 #3.6 36 360 #0.5 7 30 90 360 
do
for iii in 1 0 #1
do
for taus in 1.40 #0.00 2.00 10.00
do
...
#do
  ...
  sed -i -e 's/real    :: taul0   =  1.03/real    :: taul0   =  '$taul'/g' radmod.f90
