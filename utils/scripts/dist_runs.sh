...
for i in 1.0 0.5 0.0625 #####0.0625 0.125 0.25 0.5 1.0 2.0 4.0 8.0   ###1.0 0.44 0.14 0.044 2.0 #0.44 1.0
do
  a="$(round 1.0/$i 5)"
  cp -rf $HOME/puma/trunk/pumas $LOCATION/$BASENAME$i$NAME2$a
  ...
  #cp -rf puma_spindown2.f90 puma.f90
