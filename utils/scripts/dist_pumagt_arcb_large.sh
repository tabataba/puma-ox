...
do
for psurffac in 0.04 #30.0 150 #0.04 0.2 1.0 5.0 #0.02 30.0
do
for i in 0.5 #0.25 0.5 1.0 #0.0625 0.125 0.25 0.5 1.0 #2.0 4.0 8.0   ###1.0 0.44 0.14 0.044 2.0 #0.44 1.0
do
for k in 3.6 #36 360 #0.5 7 30 90 360 
do
for iii in 0 1 #1
do
for taus in 1.00 2.00 #0.00 2.00 10.00 #0.20     #0.00 2.00 10.00
do
