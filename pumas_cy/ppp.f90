...
!     =================
      ...
      if (mypid == NROOT) then
         call ppp_write_is('NLAT',nlat)
         call ppp_write_is('NLEV',nlev)
         call ppp_write_is('NHELSUA',nhelsua)
...
!     This namelist must be identical to namelist inp in puma.f90
       ...
       , ndl     , nextout , nfls    , ngui    , nguidbg , nhelsua &
       , nsync   , ntestgp , nkits   &
...
!     =======================
!     SUBROUTINE ppp_write_is
!     =======================

      subroutine ppp_write_is(yvarname,ival)
      use pumamod
