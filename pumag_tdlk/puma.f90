...
integer  :: ntdlk   = 0 ! 0/1 switch for tidal-lock  
...
call mpbci(ntdlk)    ! 0/1 switch for tidal-lock
...
!     implemented.
     ...
     &                        * real(NLEV - 1 - jlev) + zsigmin
         ...
         enddo
!         do jlev = NLEV,NLEV-9,-1
!            sigmh(jlev) = real(jlev-(NLEV-10)) / 10.0
!         enddo
!         do jlev = 1,NLEV-10
!            sigmh(jlev) = real(jlev) / real(NLEV-9) * 0.1
!         enddo
         return     
