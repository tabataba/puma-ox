...
!     ============================
!     SUBROUTINE GET_RESTART_ARRAYI
!     ============================

      subroutine get_restart_arrayi(yn,pa,k1,k2,k3)
      use restartmod
      ...
      return
      end subroutine get_restart_arrayi
...
!     ============================
!     SUBROUTINE PUT_RESTART_ARRAYI
!     ============================

      subroutine put_restart_arrayi(yn,pa,k1,k2,k3)
      use restartmod
      ...
      write(nwriunit) pa(1:k1,1:k3)
      return
      end subroutine put_restart_arrayi
